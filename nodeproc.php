		...
		<div class=\"container-fluid\">
			<div class=\"navbar-header\">
				...
				<ul class=\"nav navbar-nav\">
					...
					<li class=\"active\"><a href=\"nodeproc.php\">Node jobs</a></li>
...
echo "<h1 style=\"text-align:center;\">" . $node . " active jobs </h1>";
echo "<br>";
...
$command= "squeue -o '%i,%P,%j,%u,%T,%R,%M,%l,%D,%N' --nodelist=" . $node;
